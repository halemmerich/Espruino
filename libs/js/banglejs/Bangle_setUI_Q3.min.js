...
(a,d)=>{f();e(d)};else if("custom"==c)b.clock&&(Bangle.CLOCK=1),b.touch&&(Bangle.touchHandler=b.touch),b.drag&&(Bangle.dragHandler=b.drag,Bangle.on("drag",Bangle.dragHandler)),b.swipe&&(Bangle.swipeHandler=b.swipe,Bangle.on("swipe",Bangle.swipeHandler)),b.btn?Bangle.btnWatches=[setWatch(function(){b.btn(1)},BTN1,{repeat:1,edge:"falling"})]:b.clock&&(Bangle.btnWatches=[setWatch(Bangle.showLauncher,BTN1,{repeat:1,edge:"falling"})]);else throw Error("Unknown UI mode");b.remove&&(Bangle.uiRemove=b.remove);
if(b.back){var n=(a,d)=>{36>d.y&&48>d.x&&(d.handled=!0,b.back())};Bangle.on("touch",n);if(Bangle.touchHandler){var p=Bangle.touchHandler;Bangle.touchHandler=(a,d)=>{d.handled||p(a,d)};Bangle.on("touch",Bangle.touchHandler)}var l=setWatch(function(){l=void 0;b.back()},BTN1,{edge:"falling"});WIDGETS=Object.assign({back:{area:"tl",width:24,draw:a=>g.reset().setColor("#f00").drawImage(atob("GBiBAAAYAAH/gAf/4A//8B//+D///D///H/P/n+H/n8P/n4f/vwAP/wAP34f/n8P/n+H/n/P/j///D///B//+A//8Af/4AH/gAAYAA=="),a.x,
a.y),remove:a=>{l&&clearWatch(l);Bangle.removeListener("touch",n);a||g.reset().clearRect({x:WIDGETS.back.x,y:WIDGETS.back.y,w:24,h:24});delete WIDGETS.back;a||Bangle.drawWidgets()}}},global.WIDGETS);m&&Bangle.drawWidgets()}else if(Bangle.touchHandler)Bangle.on("touch",Bangle.touchHandler)}if(WIDGETS){for(let w of WIDGETS){if(w.update)w.update();}}})
